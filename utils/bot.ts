    ...
    return  axios.post(process.env.BASE_BOT_URL + '/message/embed', 
        {
          ...
          "thumbnail": "[https://i.imgur.com/XQ9xZ9u.png](https://i.imgur.com/XQ9xZ9u.png)",
          "title": data.title,
...
export const sendMessageUserToCalobot = (userId: string, data: IBotData, isEmbed = true) => {
    return axios.post(process.env.BASE_BOT_URL + `/message/user/${userId}`,
      {
        "author": {
           "name": "Mentorship",
           "iconURL": "[https://i.imgur.com/XQ9xZ9u.png](https://i.imgur.com/XQ9xZ9u.png)"
         },
         "description": data.description,
         "color": "ff0000",
         "URL": "",
